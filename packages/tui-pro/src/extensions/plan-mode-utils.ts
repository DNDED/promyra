...
export function extractTodoItems(message: string): PlanTodo[] {
...
export function markCompletedSteps(text: string, items: PlanTodo[]): number {
...
export function countProgress(items: PlanTodo[]): { done: number; total: number } {
