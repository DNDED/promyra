...
export { handleKey, handleInsertKey, handleNormalKey, handleVisualKey, INITIAL_RUNTIME } from "./util/vim-dispatch.js";
export type { VimRuntime, YankBuffer } from "./util/vim-dispatch.js";
export type { VimState, VimMode, OpKind, OpResult } from "./util/vim.js";
export { applyDelete, applyLineDelete, applyLineYank, applyLineChange, pasteAfter, pasteBefore, wordForwardN, wordBackwardN, wordEndN, pushUndo, clampCursor } from "./util/vim.js";
